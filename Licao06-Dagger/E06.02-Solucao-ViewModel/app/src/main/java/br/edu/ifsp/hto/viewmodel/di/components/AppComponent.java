...
//TODO(2) Adicionar o ViewModelModule neste componente
@Singleton
@Component(modules = {AndroidInjectionModule.class, AppModule.class, RoomModule.class, ViewModelModule.class})
